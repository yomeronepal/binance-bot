...
# Test different breathing room configurations
# CONFIGS = [
#     {
#         "name": "DOGEUSDT 4h BR1 - Wider SL (2.5x ATR)",
#         "symbol": "DOGEUSDT",
#         "timeframe": "4h",
...
#             "short_rsi_min": 67.0,
#             "short_rsi_max": 77.0,
#             "sl_atr_multiplier": 2.5,  # More breathing room
#             "tp_atr_multiplier": 7.0   # Maintain 1:2.8 R/R
#         }
#     },
#     {
#         "name": "DOGEUSDT 4h BR2 - Even Wider SL (3.0x ATR)",
#         "symbol": "DOGEUSDT",
#         "timeframe": "4h",
#         "start_date": "2023-01-01T00:00:00Z",
#         "end_date": "2024-12-31T23:59:59Z",
...
#             "short_rsi_min": 67.0,
#             "short_rsi_max": 77.0,
#             "sl_atr_multiplier": 3.0,  # Maximum breathing room
#             "tp_atr_multiplier": 8.0   # Maintain ~1:2.7 R/R
#         }
#     },
#     {
#         "name": "DOGEUSDT 4h BR3 - Balanced (2.0x ATR)",
#         "symbol": "DOGEUSDT",
#         "timeframe": "4h",
#         "start_date": "2023-01-01T00:00:00Z",
#         "end_date": "2024-12-31T23:59:59Z",
...
#             "short_rsi_min": 67.0,
#             "short_rsi_max": 77.0,
#             "sl_atr_multiplier": 2.0,  # Balanced breathing room
#             "tp_atr_multiplier": 6.0   # Maintain 1:3.0 R/R
#         }
#     },
#     {
#         "name": "DOGEUSDT 4h BR4 - Conservative (3.5x ATR) + Lower Confidence",
#         "symbol": "DOGEUSDT",
#         "timeframe": "4h",
#         "start_date": "2023-01-01T00:00:00Z",
#         "end_date": "2024-12-31T23:59:59Z",
#         "params": {
#             "min_confidence": 0.70,     # Lower to get more trades
#             "long_adx_min": 22.0,
#             "short_adx_min": 22.0,
#             "long_rsi_min": 23.0,
#             "long_rsi_max": 33.0,
#             "short_rsi_min": 67.0,
#             "short_rsi_max": 77.0,
#             "sl_atr_multiplier": 3.5,  # Very wide stop
#             "tp_atr_multiplier": 9.0   # Maintain ~1:2.6 R/R
#         }
#     }
# ]
...
CONFIGS = [
    {
        "name": "DOGEUSDT 15m BR1 - Wider SL (2.5x ATR)",
        "symbol": "DOGEUSDT",
        "timeframe": "15m",
        "start_date": "2023-01-01T00:00:00Z",
        "end_date": "2024-12-31T23:59:59Z",
    ...
    {
        "name": "DOGEUSDT 15m BR2 - Even Wider SL (3.0x ATR)",
        "symbol": "DOGEUSDT",
        "timeframe": "15m",
        "start_date": "2023-01-01T00:00:00Z",
        "end_date": "2024-12-31T23:59:59Z",
    ...
    {
        "name": "DOGEUSDT 15m BR3 - Balanced (2.0x ATR)",
        "symbol": "DOGEUSDT",
        "timeframe": "15m",
        "start_date": "2023-01-01T00:00:00Z",
        "end_date": "2024-12-31T23:59:59Z",
    ...
    {
        "name": "DOGEUSDT 15m BR4 - Conservative (3.5x ATR)",
        "symbol": "DOGEUSDT",
        "timeframe": "15m",
        "start_date": "2023-01-01T00:00:00Z",
        "end_date": "2024-12-31T23:59:59Z",
