...
const FuturesSignalCard = ({ signal, tradingMode = 'paper' }) => {
  ...
  return (
    <div className={`bg-gray-800 rounded-xl shadow-lg border ${isLong ? 'border-green-500/30' : 'border-red-500/30'
      } hover:shadow-xl transition-all duration-300 overflow-hidden`}>
      {/* Header */}
      <div className={`px-4 sm:px-6 py-4 border-b border-gray-700 ${isLong ? 'bg-green-900/20' : 'bg-red-900/20'
        }`}>
      ...
      <div className="px-6 py-4">
        ...
        <div className="mt-4 pt-4 border-t border-gray-700 flex justify-between items-center text-xs text-gray-500">
          ...
          <span className={`px-2 py-1 rounded ${signal.status === 'ACTIVE' ? 'bg-green-900/30 text-green-400' :
